...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-9b2f9039');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-9b2f9039');}
...
var brandEl=document.querySelector('.rl-brand-9b2f9039');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
